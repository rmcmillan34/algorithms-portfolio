...
%\lstinputlisting[
%  style=cpp,
%  caption={C++ Solution: LC-125 Valid Palindrome}
%]{../problems/02-strings-parsing/easy/lc-125-valid-palindrome/solution.cpp}
...
\lstinputlisting[
  ...
  frame=single,
  breaklines=true,
  caption={Python Solution: LC-125 Valid Palindrome}
]{../problems/02-strings-parsing/easy/lc-125-valid-palindrome/solution.py}
