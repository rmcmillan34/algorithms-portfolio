...
]{../problems/05-stacks-queues/easy/lc-020-valid-parentheses/solution.cpp}
...
\lstinputlisting[
  ...
  frame=single,
  breaklines=true,
  caption={Python Solution: Valid Parentheses}
]{../problems/05-stacks-queues/easy/lc-020-valid-parentheses/solution.py}
