...
\begin{CodeBlock}[style=cpp,caption={C++ Implementation}]{18}
\lstinputlisting{../../../../problems/01-arrays_sequences/plus_one/solution.cpp}
\end{CodeBlock}

\begin{CodeBlock}[style=python,caption={Python Implementation}]{16}
\lstinputlisting{../../../../problems/01-arrays_sequences/plus_one/solution.py}
\end{CodeBlock}
